...
sc = Spacecraft('Test', mass = 100, thrust_force = 3000, gas_level = 600, width=35, length=35)
...
planet2 = Planet('Tes2t', mass = 1e16, orbit = Orbit(a=screen_x*800/1920, b=screen_y*500/1080, center_x=200, center_y=screen_y/2, CW=False, angular_step = 2*np.pi/(200.0), progress = np.pi/4))
