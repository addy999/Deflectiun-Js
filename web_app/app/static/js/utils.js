...
function randomizePlanets() {
  ...
  var planets = Array.from(document.getElementsByClassName("planet"));
  planets.forEach(element => {
      ...
      element.style.mask = "url(../static/images/planets/" + rand_int.toString() + ".svg) no-repeat center / contain";
      element.style.webkitMask = "url(../static/images/planets/" + rand_int.toString() + ".svg) no-repeat center / contain";
  });
